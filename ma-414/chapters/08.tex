...
\begin{rem}
    We shall soon show that $\irr(\zeta_n, \mathbb{Q})$ is independent of the primitive root chosen (and so, $\Phi_n$ is indeed well-defined). This is \textbf{not} the case in general (see \Cref{ex:irrunityFtwo}).
\end{rem}
