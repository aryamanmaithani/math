...
\begin{enumerate}
    ...
    \item Given any field $\mathbb{F},$ $\mathbb{F}^\times$ denotes the group of units of $\mathbb{F}.$ That is, $\mathbb{F} = \mathbb{F}\setminus\{0\}.$
...
\begin{defn}%[]
    Given rings $R \subset S,$ and $\alpha \in S,$ we define $R[\alpha]$ to be the smallest subfield of $S$ containing $\alpha$ and $R.$ 
