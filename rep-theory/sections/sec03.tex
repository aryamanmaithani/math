...
\begin{aside}
	...
	$\varphi : G \to \GL(V)$ will denote a representation and $\chi_i$ the value of $\chi_\varphi$ on $C_i.$ (Recall that characters are constant on conjugacy classes, \Cref{prop:charconstonconjclasses}.)
