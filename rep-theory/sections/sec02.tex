...
We now conclude this section with completing our discussion of finite abelian groups. By \Cref{thm:irredabelgroup}, we know that every irreducible representation of $G$ has degree one. Moreover, by \Cref{cor:numberofirredrepsofG}, we know that there are $\md{G}$ many such. We now explicitly calculate all of these.
