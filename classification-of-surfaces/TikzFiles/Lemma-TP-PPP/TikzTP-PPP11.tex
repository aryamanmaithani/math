\begin{tikzpicture}
	...
	\node[] at (-2.5 + 0.26, -2.5 + 0.25) {\scriptsize (11)};
	...
	\draw[thick, -<-=at 0.5 with label {$c$}] ({\x - \radius*cos((4 * pi/3) r)}, {\y + \radius*sin((4 * pi/3) r)}) -- ({\x - \radius*cos((2 * pi/3) r)}, {\y + \radius*sin((2 * pi/3) r)});
	\draw[thick, ->-=at 0.52 with label {$c$}] ({\x +\del - \radius*cos((2 * pi/3) r)}, {\y + \radius*sin((2 * pi/3) r)}) -- ({\x +\del - \radius*cos((4 * pi/3) r)}, {\y + \radius*sin((4 * pi/3) r)});
\end{tikzpicture}