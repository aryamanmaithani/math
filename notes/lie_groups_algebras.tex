...
\end{exe}
\begin{sketch}
	Modify the inclusions and proceed as in \Cref{thm:differential-multiplication}.
\end{sketch}
...
\begin{ex}
	...
	We will show (\Cref{thm:lie-group-algebra-abelian-iff}) that this implies that $\mathcal{L}(G)$ is non-abelian. 
...
\begin{sketch}
	...
	\end{equation*}
	The domain and codomain match \Cref{eq:ad}.
...
\begin{sketch}
	...
	By \Cref{cor:image-kernel-morphism-properties}, we have
	\begin{equation*} 
...
\begin{sketch}
	...
	% Assume $G$ is abelian. 
	% Then $\INT(g) = \id_{G}$ for any $g \in G$. 
	% Thus, $\Ad(g) = \id_{T_{1}(G)}$ for all $g \in G$. 
	% Thus, $\Ad$ is constant and hence $[-, -] = T_{1}(\Ad)(-)(-) = 0$.

	\backward Assume $G$ is connected and $\mathcal{L}(G)$ is abelian. 
	Let $Z$ be the center of $G$.
	By \Cref{thm:center-lie-group-lie-algebra}, $\mathcal{L}(Z) = \mathcal{L}(G)$. 
	By \Cref{por:connected-lie-subgroup-equal-lie-algebra}, $Z = G$.
\end{sketch}
